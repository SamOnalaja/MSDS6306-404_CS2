...
aaaa <- data.frame(knn.mat$byClass[1],knn.mat$byClass[2],knn.mat$overall[1])
row.names(aaaa) <- NULL
names(aaaa) <- c( "Specificity", "Sensitivity","Accuracy")
aaaa
```
...
#knn.mat$byClass[1],knn.mat$byClass[2],knn.mat$overall[1])
